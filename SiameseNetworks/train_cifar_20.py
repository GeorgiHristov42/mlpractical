...
from cifar_dataset_20 import BatchGenerator, get_cifar
from model import *
...
train_step = tf.train.MomentumOptimizer(0.000001, 0.99, use_nesterov=True).minimize(loss, global_step=global_step)
