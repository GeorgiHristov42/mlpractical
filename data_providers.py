...
class CIFAR100_1_shot(DataProvider):
    """Data provider for CIFAR-100 object images."""

    def __init__(self, which_set='train', batch_size=10, max_num_batches=-1,
                 shuffle_order=True, rng=None, flatten=False, one_hot=False):
        """Create a new EMNIST data provider object.
        ...
        if self.which_set is 'train':
            data_path = os.path.join(
                os.environ['MLP_DATA_DIR'], 'cifar_1_shot.npy')
        else:
            data_path = os.path.join(
                os.environ['MLP_DATA_DIR'], 'cifar100-{0}.npz'.format(which_set))
        assert os.path.isfile(data_path), (
...
class CIFAR100_5_shot(DataProvider):
    """Data provider for CIFAR-100 object images."""
...
class CIFAR100_10_shot(DataProvider):
    """Data provider for CIFAR-100 object images."""
...
class CIFAR100_20_shot(DataProvider):
    """Data provider for CIFAR-100 object images."""
...
class CIFAR100_50_shot(DataProvider):
    """Data provider for CIFAR-100 object images."""
